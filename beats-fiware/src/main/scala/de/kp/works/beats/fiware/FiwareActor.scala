...
import de.kp.works.beats.events.FiwareEvent
...
abstract class BaseActor extends Actor with ActorLogging {
  ...
  val fiwareCfg: Config = BeatsConf.getBeatCfg(BeatsConf.FIWARE_CONF)
  val actorCfg: Config = fiwareCfg.getConfig("actor")
