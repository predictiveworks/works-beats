...
class OpcUaRoutes(actors:Map[String, ActorRef], source:Source[ServerSentEvent, NotUsed]) extends BeatsRoutes(source) {
  /**
   * The [OpcUaBeat] is restricted to a Http(s) server
