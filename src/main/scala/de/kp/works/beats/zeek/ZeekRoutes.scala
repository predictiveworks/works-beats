...
class ZeekRoutes(actors:Map[String, ActorRef], source:Source[ServerSentEvent, NotUsed]) extends BeatsRoutes(source) {
  /**
   * The [ZeekBeat] is restricted to a Http(s) server
