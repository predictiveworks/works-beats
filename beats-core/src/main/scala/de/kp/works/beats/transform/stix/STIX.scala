...
object STIX {
  ...
  val ENTITY_TYPE_GROUPING          = "grouping"
  val ENTITY_TYPE_IDENTITY          = "identity"
  /*
   * Incident is no official STIX v2.1 object, but
   * already used as a STUB
   */
  ...
  val ENTITY_TYPE_MALWARE_ANALYSIS  = "malware-analysis"
  /* Container objects */
  val ENTITY_TYPE_NOTE              = "note"
  val ENTITY_TYPE_OBSERVED_DATA     = "observed-data"
  val ENTITY_TYPE_OPINION           = "opinion"
  val ENTITY_TYPE_REPORT            = "report"
  /* Single objects */
  ...
  val ENTITY_TYPE_OBJECT_MARKING     = "object-marking"
  val ENTITY_TYPE_OBJECT_REFERENCE   = "object-reference"
  ...
  /*
   * The following set specifies the STIX v2.1
   * domain objects
   */
  ...
  /*
   * The following set specifies the STIX v2.1
   * domain objects that are used as containers
   * for other objects or observables.
   */
  ...
  val STIX_RELATIONSHIP = "relationship"
  val STIX_SIGHTING     = "sighting"
