...
case class StructField(name:String, dataType:String, nullable:Boolean)
...
object ZeekSchema {
  ...
  def capture_loss(): StructType = {
    ...
    val fields = Array(
       ...
       * name.
       */
      StructField("peer", "String", nullable = false),
       ...
       */
      StructField("acks", "Integer", nullable = false),

      /* percent_lost: Percentage of ACKs seen where the data being ACKed wasn’t seen.
       */
      StructField("percent_lost", "Double", nullable = false)
  ...
  def conn(): StructType = {
    ...
    var fields = Array(
       ...
       */
      StructField("uid", "String", nullable = false)
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("proto", "String", nullable = false),

      /* service: An identification of an application protocol being sent over
       * the connection.
       */
      StructField("service", "String", nullable = true),
       ...
       */
      StructField("duration", "Long", nullable = true),
       ...
       */
      StructField("missed_bytes", "Integer", nullable = true),

      /* history: Records the state history of connections as a string of letters.
       */
      StructField("history", "String", nullable = true),

      /* orig_pkts: Number of packets that the originator sent.
       */
      StructField("source_pkts", "Integer", nullable = true),
       ...
       */
      StructField("source_ip_bytes", "Integer", nullable = true),

      /* resp_pkts: Number of packets that the responder sent.
       */
      StructField("destination_pkts", "Integer", nullable = true),

      /* resp_ip_bytes: Number of IP level bytes that the responder sent (as seen on the wire,
       * taken from the IP total_length header field).
       */
      StructField("destination_ip_bytes", "Integer", nullable = true),
       ...
       */
      StructField("speculative_service", "String", nullable = true)
  ...
  def dce_rpc(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("rtt", "Long", nullable = true),

      /* named_pipe: Remote pipe name.
       */
      StructField("named_pipe", "String", nullable = true),

      /* endpoint: Endpoint name looked up from the uuid.
       */
      StructField("endpoint", "String", nullable = true),

      /* operation: Operation seen in the call.
       */
      StructField("operation", "String", nullable = true)
  ...
  def dhcp(): StructType = {
    ...
    val fields = Array(
       ...
       */
      StructField("uids", "Array[String]", nullable = false),
       ...
       */
      StructField("client_addr", "String", nullable = true),
       ...
       */
      StructField("server_addr", "String", nullable = true),

      /* mac: Client’s hardware address.
       */
      StructField("mac", "String", nullable = true),

      /* host_name: Name given by client in Hostname.
       */
      StructField("host_name", "String", nullable = true),

      /* client_fqdn: FQDN given by client in Client FQDN
       */
      StructField("client_fqdn", "String", nullable = true),

      /* domain: Domain given by the server
       */
      StructField("domain", "String", nullable = true),

      /* requested_addr: IP address requested by the client.
       */
      StructField("requested_addr", "String", nullable = true),

      /* assigned_addr: IP address assigned by the server.
       */
      StructField("assigned_addr", "String", nullable = true),

      /* lease_time: IP address lease interval.
       */
      StructField("lease_time", "Long", nullable = true),
       ...
       */
      StructField("circuit_id", "String", nullable = true),

      /* agent_remote_id: A globally unique identifier added by relay agents to identify the
       * remote host end of the circuit.
       */
      StructField("agent_remote_id", "String", nullable = true),
       ...
       */
      StructField("subscriber_id", "String", nullable = true)
  ...
  def dnp3(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("fc_request", "String", nullable = true),

      /* fc_reply: The name of the function message in the reply.
       */
      StructField("fc_reply", "String", nullable = true),

      /* iin: The response’s “internal indication number”.
       */
      StructField("iin", "Integer", nullable = true)
  ...
  def dns(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       * queries.
       */
      StructField("trans_id", "Integer", nullable = true),
  ...
  def dpd(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("analyzer", "String", nullable = false),

      /* failure_reason: The textual reason for the analysis failure.
       */
      StructField("failure_reason", "String", nullable = false),

      /* packet_segment: A chunk of the payload that most likely resulted in
       * the protocol violation.
       */
      StructField("packet_segment", "String", nullable = true)
  ...
  def files(): StructType = {
    ...
    val fields = Array(
       ...
       */
      StructField("fuid", "String", nullable = false),
       ...
       */
      StructField("source_ips", "Array[String]", nullable = true),
       ...
       */
      StructField("destination_ips", "Array[String]", nullable = true),

      /* conn_uids: Connection UIDs over which the file was transferred.
       */
      StructField("conn_uids", "Array[String]", nullable = true),
       ...
       */
      StructField("source", "String", nullable = true),
       ...
       */
      StructField("depth", "Integer", nullable = true),

      /* analyzers: A set of analysis types done during the file analysis.
       */
      StructField("analyzers", "Array[String]", nullable = true),
       ...
       */
      StructField("mime_type", "String", nullable = true),
       ...
       * by the configured
       */
      StructField("local_orig", "Boolean", nullable = true),
  ...
  def ftp(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("user", "String", nullable = true),

      /* password: Password for the current FTP session if captured.
       */
      StructField("password", "String", nullable = true),

      /* command: Command given by the client.
       */
      StructField("command", "String", nullable = true),

      /* arg: Argument for the command if one is given.
       */
      StructField("arg", "String", nullable = true),
  ...
  def http(): StructType = {
     ...
     */
      StructField("trans_depth", "Integer", nullable = false),

      /* method: Verb used in the HTTP request (GET, POST, HEAD, etc.).
       */
      StructField("method", "String", nullable = true),

      /* host: Value of the HOST header.
       */
      StructField("host", "String", nullable = true),

      /* uri: URI used in the request.
       */
      StructField("uri", "String", nullable = true),
       ...
       */
      StructField("client_header_names", "Array[String]", nullable = true),

      /* server_header_names: The vector of HTTP header names sent by the server.
       * No header values are included here, just the header names.
       */
      StructField("server_header_names", "Array[String]", nullable = true),

      /* cookie_vars: Variable names extracted from all cookies.
       */
      StructField("cookie_vars", "Array[String]", nullable = true),

      /* uri_vars: Variable names from the URI.
       */
      StructField("uri_vars", "Array[String]", nullable = true)
  ...
  def intel(): StructType = {
    ...
    var fields = Array(
       ...
       */
      StructField("uid", "String", nullable = true)
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("seen_indicator", "String", nullable = true),
       ...
       */
      StructField("file_mime_type", "String", nullable = true),
  ...
  def irc(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("nick", "String", nullable = true),
       ...
       */
      StructField("value", "String", nullable = true),

      /* addl: Any additional data for the command.
       */
      StructField("addl", "String", nullable = true),

      /* dcc_file_name: DCC filename requested.
       */
      StructField("dcc_file_name", "String", nullable = true),

      /* dcc_file_size: Size of the DCC transfer as indicated by the sender.
       */
      StructField("dcc_file_size", "Integer", nullable = true),

      /* dcc_mime_type: Sniffed mime type of the file.
       */
      StructField("dcc_mime_type", "String", nullable = true),
  ...
  def kerberos(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("request_type", "String", nullable = true),

      /* client: Client.
       */
      StructField("client", "String", nullable = true),
       ...
       */
      StructField("success", "String", nullable = true),

      /* error_msg: Error message.
       */
      StructField("error_msg", "String", nullable = true),

      /* from: Ticket valid from.
       */
      StructField("from", "Long", nullable = true),

      /* till: Ticket valid till.
       */
      StructField("till", "Long", nullable = true),

      /* cipher: Ticket encryption type.
       */
      StructField("cipher", "String", nullable = true),

      /* forwardable: Forwardable ticket requested.
       */
      StructField("forwardable", "String", nullable = true),

      /* renewable: Renewable ticket requested.
       */
      StructField("renewable", "String", nullable = true),

      /* client_cert_subject: Subject of client certificate, if any.
       */
      StructField("client_cert_subject", "String", nullable = true),

      /* client_cert_fuid: File unique ID of client cert, if any.
       */
      StructField("client_cert_fuid", "String", nullable = true),

      /* server_cert_subject: Subject of server certificate, if any.
       */
      StructField("server_cert_subject", "String", nullable = true),

      /* server_cert_fuid: File unique ID of server cert, if any.
       */
      StructField("server_cert_fuid", "String", nullable = true),

      /* auth_ticket: Hash of ticket used to authorize request/transaction.
       */
      StructField("auth_ticket", "String", nullable = true),

      /* new_ticket: Hash of ticket returned by the KDC.
       */
      StructField("new_ticket", "String", nullable = true)
  ...
  def modbus(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("func", "String", nullable = true),

      /* exception: The exception if the response was a failure.
       */
      StructField("exception", "String", nullable = true)
  ...
  def mysql(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("cmd", "String", nullable = false),

      /* arg: The argument issued to the command.
       */
      StructField("arg", "String", nullable = false),

      /* success: Did the server tell us that the command succeeded?
       */
      StructField("success", "Boolean", nullable = true),

      /* rows: The number of affected rows, if any.
       */
      StructField("rows", "Integer", nullable = true),

      /* response: Server message, if any.
       */
      StructField("response", "String", nullable = true)
  ...
  def notice(): StructType = {
    ...
    var fields = Array(
       ...
       */
      StructField("ts", "Long", nullable = true),
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("proto", "String", nullable = true),

      /* note: The Notice::Type of the notice.
       */
      StructField("note", "String", nullable = true),

      /* msg: The Notice::Type of the notice.
       */
      StructField("msg", "String", nullable = true),

      /* sub: The human readable sub-message.
       */
      StructField("sub", "String", nullable = true),

      /* src: Source address, if we don’t have a conn_id.
       */
      StructField("source_ip", "String", nullable = true),

      /* dst: Destination address.
       */
      StructField("destination_ip", "String", nullable = true),
       ...
       */
      StructField("country_code", "String", nullable = true),

      /* remote_location.region: The The region.
       */
      StructField("region", "String", nullable = true),

      /* remote_location.city: The city.
       */
      StructField("city", "String", nullable = true),

      /* remote_location.latitude: The latitude.
       */
      StructField("latitude", "Double", nullable = true),

      /* remote_location.longitude: longitude.
       */
      StructField("longitude", "Double", nullable = true),

      /* dropped: Indicate if the $src IP address was dropped and denied network access.
       */
      StructField("dropped", "Boolean", nullable = true)
  ...
  def ntlm(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("hostname", "String", nullable = true),

      /* domainname: Domainname given by the client.
       */
      StructField("domainname", "String", nullable = true),

      /* server_nb_computer_name: NetBIOS name given by the server in a CHALLENGE.
       */
      StructField("server_nb_computer_name", "String", nullable = true),

      /* server_dns_computer_name: DNS name given by the server in a CHALLENGE.
       */
      StructField("server_dns_computer_name", "String", nullable = true),

      /* server_tree_name: Tree name given by the server in a CHALLENGE.
       */
      StructField("server_tree_name", "String", nullable = true),
  ...
  def radius(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("framed_addr", "String", nullable = true),
       ...
       */
      StructField("tunnel_client", "String", nullable = true),

      /* connect_info: Connect info, if present.
       */
      StructField("connect_info", "String", nullable = true),
       ...
       */
      StructField("result", "String", nullable = true),
       ...
       * was not seen.
       */
      StructField("ttl", "Long", nullable = true)
  ...
  def rdp(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("cookie", "String", nullable = true),
  ...
  def rfb(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("client_major_version", "String", nullable = true),

      /* client_minor_version: Minor version of the client.
       */
      StructField("client_minor_version", "String", nullable = true),

      /* server_major_version: Major version of the server.
       */
      StructField("server_major_version", "String", nullable = true),

      /* server_minor_version: Minor version of the server.
       */
      StructField("server_minor_version", "String", nullable = true),

      /* authentication_method: Identifier of authentication method used.
       */
      StructField("authentication_method", "String", nullable = true),

      /* auth: Whether or not authentication was successful.
       */
      StructField("auth", "Boolean", nullable = true),

      /* share_flag: Whether the client has an exclusive or a shared session.
       */
      StructField("share_flag", "Boolean", nullable = true),

      /* desktop_name: Name of the screen that is being shared.
       */
      StructField("desktop_name", "String", nullable = true),

      /* width: Width of the screen that is being shared.
       */
      StructField("width", "Integer", nullable = true),

      /* height: Height of the screen that is being shared.
       */
      StructField("height", "Integer", nullable = true)
  ...
  def sip(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("date", "String", nullable = true),
       ...
       */
      StructField("warning", "String", nullable = true),
       ...
       */
      StructField("content_type", "String", nullable = true)
  ...
  def smb_cmd(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("command", "String", nullable = false),

      /* sub_command: The subcommand sent by the client, if present.
       */
      StructField("sub_command", "String", nullable = true),

      /* argument: Command argument sent by the client, if any.
       */
      StructField("argument", "String", nullable = true),

      /* status: Server reply to the client’s command.
       */
      StructField("status", "String", nullable = true),
       ...
       */
      StructField("version", "String", nullable = false),
  ...
  def smb_files(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("action", "String", nullable = true),

      /* path: Path pulled from the tree this file was transferred to or from.
       */
      StructField("path", "String", nullable = true),
  ...
  def smtp(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("helo", "String", nullable = true),

      /* mailfrom: Email addresses found in the From header.
       */
      StructField("mailfrom", "String", nullable = true),

      /* rcptto: Email addresses found in the Rcpt header.
       */
      StructField("rcptto", "Array[String]", nullable = true),
       ...
       */
      StructField("from", "String", nullable = true),

      /* to: Contents of the To header.
       */
      StructField("to", "Array[String]", nullable = true),

      /* cc: Contents of the CC header.
       */
      StructField("cc", "Array[String]", nullable = true),
       ...
       */
      StructField("msg_id", "String", nullable = true),

      /* in_reply_to: Contents of the In-Reply-To header.
       */
      StructField("in_reply_to", "String", nullable = true),
  ...
  def socks(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("version", "Integer", nullable = false),
      ...
      /* request.host:
       */
      StructField("request_host", "String", nullable = true),

      /* request.name:
       */
      StructField("request_name", "String", nullable = true),

      /* request_p: Client requested port.
       */
      StructField("request_port", "Integer", nullable = true),

      /* bound: Server bound address. Could be an address, a name or both. */

      /* bound.host:
       */
      StructField("bound_host", "String", nullable = true),

      /* bound.name:
       */
      StructField("bound_name", "String", nullable = true),

      /* bound_p: Server bound port.
       */
      StructField("bound_port", "Integer", nullable = true)
  ...
  def ssh(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("auth_success", "Boolean", nullable = true),
       ...
       * pubkey)
       */
      StructField("auth_attempts", "Integer", nullable = true),
       ...
       */
      StructField("direction", "String", nullable = true),
       ...
       */
      StructField("server", "String", nullable = true),

      /* cipher_alg: The encryption algorithm in use.
       */
      StructField("cipher_alg", "String", nullable = true),

      /* mac_alg: The signing (MAC) algorithm in use.
       */
      StructField("mac_alg", "String", nullable = true),

      /* compression_alg: The compression algorithm in use.
       */
      StructField("compression_alg", "String", nullable = true),

      /* kex_alg: The key exchange algorithm in use.
       */
      StructField("kex_alg", "String", nullable = true),

      /* host_key_alg: The server host key’s algorithm.
       */
      StructField("host_key_alg", "String", nullable = true),

      /* host_key: The server’s key fingerprint.
       */
      StructField("host_key", "String", nullable = true),
  ...
  def ssl(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("curve", "String", nullable = true),
  ...
  def syslog(): StructType = {
    ...
    fields = fields ++ Array(
      ...
      */
      StructField("facility", "String", nullable = false),

      /* severity: Syslog severity for the message.
      */
      StructField("severity", "String", nullable = false),

      /* message: The plain text message.
      */
      StructField("message", "String", nullable = false)
  ...
  def traceroute(): StructType = {
    ...
    val fields = Array(
       ...
       */
      StructField("source_ip", "String", nullable = false),

      /* dst: Destination address of the traceroute.
       */
      StructField("destination_ip", "String", nullable = false),
  ...
  def tunnel(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("tunnel_type", "String", nullable = false),

      /* action: The type of activity that occurred.
       */
      StructField("action", "String", nullable = false)
  ...
  def weird(): StructType = {
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("name", "String", nullable = false),
       ...
       */
      StructField("notice", "Boolean", nullable = true),
       ...
       */
      StructField("peer", "String", nullable = true)
  ...
  def x509(): StructType = {
    ...
    var fields = Array(
       ...
       */
      StructField("file_id", "String", nullable = true)
    ...
    fields = fields ++ Array(
       ...
       */
      StructField("san_dns", "Array[String]", nullable = true),

      /* san.uri: List of URI entries in SAN
       */
      StructField("san_uri", "Array[String]", nullable = true),

      /* san.email: List of email entries in SAN
       */
      StructField("san_email", "Array[String]", nullable = true),

      /* san.ip: List of IP entries in SAN
       */
      StructField("san_ip", "Array[String]", nullable = true),

      /* san.other_fields: True if the certificate contained other, not recognized or parsed name fields.
       */
      StructField("san_other_fields", "Boolean", nullable = true),

      /** * BASIC CONSTRAINTS ** */

      /* basic_constraints.ca: CA flag set?
       */
      StructField("basic_constraints_ca", "Boolean", nullable = true),

      /* basic_constraints.path_len: Maximum path length.
       */
      StructField("basic_constraints_path_len", "Integer", nullable = true)
  ...
  def certificate(): Array[StructField] = {
    ...
    val fields = Array(
       ...
       */
      StructField("cert_version", "Integer", nullable = false),

      /* certificate.serial: Serial number.
       */
      StructField("cert_serial", "String", nullable = false),

      /* certificate.subject: Subject.
       */
      StructField("cert_subject", "String", nullable = false),

      /* certificate.cn: Last (most specific) common name.
       */
      StructField("cert_cn", "String", nullable = true),

      /* certificate.not_valid_before: Timestamp before when certificate is not valid.
       */
      StructField("cert_not_valid_before", "Long", nullable = false),

      /* certificate.not_valid_after: Timestamp after when certificate is not valid.
       */
      StructField("cert_not_valid_after", "Long", nullable = false),

      /* certificate.key_alg: Name of the key algorithm.
       */
      StructField("cert_key_alg", "String", nullable = false),

      /* certificate.sig_alg: Name of the signature algorithm.
       */
      StructField("cert_sig_alg", "String", nullable = false),

      /* certificate.key_type: Key type, if key parsable by openssl (either rsa, dsa or ec).
       */
      StructField("cert_key_type", "String", nullable = true),

      /* certificate.key_length: Key length in bits.
       */
      StructField("cert_key_length", "Integer", nullable = true),

      /* certificate.exponent: Exponent, if RSA-certificate.
       */
      StructField("cert_exponent", "String", nullable = true),

      /* certificate.curve: Curve, if EC-certificate.
       */
      StructField("cert_curve", "String", nullable = true)
  ...
  def conn_id(): Array[StructField] = {
    ...
    val fields = Array(
       ...
       */
      StructField("source_port", "Integer", nullable = false),
       ...
       */
      StructField("destination_port", "Integer", nullable = false)
  ...
  def conn_id_nullable(): Array[StructField] = {
    ...
    val fields = Array(
      ...
      /* id.resp_p: The responder’s port number.
       */
      StructField("destination_port", "Integer", nullable = true)
